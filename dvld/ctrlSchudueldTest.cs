...
namespace dvld
{
    public partial class ctrlSchudueldTest : UserControl
    {
        ...
        private clsTestAppoitment _TestAppointment;
        public void LoadInfo(int TestAppointmentID)
        {
            _TestAppointmentID = TestAppointmentID;
            _TestAppointment = clsTestAppoitment.Find(_TestAppointmentID);
