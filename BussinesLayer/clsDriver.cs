...
namespace BussinesLayer
{
    public class clsDriver
    {
        ...
        private bool _AddNewDriver()
        {
            ...
            this.DriverID = DataDriver.AddNewDriver(PersonID, CreatedByUserID);
        ...
        {
            //call DataAccess Layer 
            return DataDriver.UpdateDriver(this.DriverID, this.PersonID, this.CreatedByUserID);
        }
        ...
        public static clsDriver FindByPersonID(int PersonID)
        {
            ...
            if (DataDriver.GetDriverInfoByPersonID(PersonID, ref DriverID, ref CreatedByUserID, ref CreatedDate))
                return new clsDriver(DriverID, PersonID, CreatedByUserID, CreatedDate);
            else
                return null;
        }
