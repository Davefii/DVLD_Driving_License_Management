...
namespace BussinesLayer
{
    public class clsApplication
    {
        ...
        private bool _AddNewApplication()
        {
            ...
            this.ApplicationID = DataApplication.AddNewApplication(
        ...
        private bool _UpdateApplication()
        {
            ...
            return DataApplication.UpdateApplication(this.ApplicationID, this.ApplicantPersonID, this.ApplicationDate,
                this.ApplicationTypeID, (byte)this.ApplicationStatus,
                this.LastStatusDate, this.PaidFees, this.CreatedByUserID);
        ...
        public bool Cancel()
        {
            return DataApplication.UpdateStatus(ApplicationID, 2);
        }
        public bool SetComplete()
        {
            return DataApplication.UpdateStatus(ApplicationID, 3);
        }
        public bool Save()
        {
            switch (Mode)
